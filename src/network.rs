...
pub trait NetworkInterfaceOperations {
    async fn put_network_interface(&self, iface_id: &str, interface: &NetworkInterface) -> Result<(), FirecrackerError>;
    async fn patch_network_interface(&self, iface_id: &str, interface: &NetworkInterface) -> Result<(), FirecrackerError>;
}
